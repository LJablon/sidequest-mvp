            ...
            {user.media && user.media.length > 0 && (
              <div className="p-6 bg-gray-100 rounded-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {user.media.map((item: any, index: number) => (
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <p className="text-sm font-medium text-gray-900 truncate">
                                {item.documentFile ? (item.documentFile as any).name : 'External Document'}
                              </p>
                              <p className="text-xs text-gray-500">
                                {item.documentFile ? `${((item.documentFile as any).size / 1024 / 1024).toFixed(2)} MB` : 'External Link'}
                              </p>
                            </div>
                            <a
                              href={item.documentUrl || (item.documentFile as any)?.url}
                              target="_blank"
                              rel="noopener noreferrer"
